...
graph [
  ...
  node [
    id 9
    LabelGraphics [ text "Jeerinah Formation[1]" fontSize 14 ]
    gid -2
  ...
  edge [
    ...
    LabelGraphics [ text "3" fill "#00ff00" fontSize 14 fontStyle "bold" model "centered" position "center" outline "#000000"]
  ]
  edge [
    source 1
    target 9
