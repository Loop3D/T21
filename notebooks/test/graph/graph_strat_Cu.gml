...
graph [
  ...
  node [
    id 9
    LabelGraphics [ text "Hardey Formation" fontSize 14 ]
    gid -4
    graphics [ fill "#ffffff" w 150 ]
  ]
  node [
  ...
  node [
    id 23
    LabelGraphics [ text "Rocklea Inlier metagranitic unit" fontSize 14 ]
    gid -22
    graphics [ fill "#ffffff" w 150 ]
  ]
  node [
  ...
  node [
    id 0
    LabelGraphics [ text "Wittenoom Formation" fontSize 14 ]
    gid -3
    graphics [ fill "#ffffff" w 150 ]
  ]
  node [
  ...
  edge [
    ...
    LabelGraphics [ text "1" fill "#80ff80" fontSize 14 fontStyle "bold" model "centered" position "center" outline "#000000"]
  ]
  edge [
    source 8
    target 3
